...
export type ResolvedProvider<V, T> = (
  root: Target,
...
export type Binding<O, T> = O extends ITarget
  ? InputBinding<T>
  : O extends ReferenceI<infer V, any>
    ? InputBinding<V>
    : O extends ReferenceO<infer V, infer T, infer A, any>
      ? OutputBinding<V, T, A>
      : never;
